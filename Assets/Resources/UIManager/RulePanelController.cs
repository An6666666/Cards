...
public class RulePanelController : MonoBehaviour
{
    ...
    private static readonly DefaultReactionSeed[] DefaultReactionSeeds =
    {
        ...
        new() { Id = "Water_Thunder", A = "Water", B = "Thunder", Combination = "水 + 雷", Title = "導電", Description = "水+雷的導電反應，會沿著相連的水地板與帶有水元素的妖怪傳導，對其他目標造成0.5倍傷害，並留下後者的元素。" },
        ...
        new() { Id = "Thunder_Wood", A = "Thunder", B = "Wood", Combination = "雷 + 木", Title = "雷擊", Description = "雷+木的雷擊反應，會累積2層雷擊效果，最後1層消耗時使該次傷害變成2倍，且每回合會減少1層。" },
